addLayer("p", {
    ...
    update(diff){
        ...
        player.p.ascendMult = (player.p.maxMult).div(500).max(1).pow(0.35).floor().max(1).log2().pow(8/3).floor().times(2).add(2).pow(player.p.baseAscend)
        ...
        player.p.ascendBoost = (player.p.maxMult).div(250).max(1).pow(0.5).floor().pow(0.2).max(1).log10().times(10).round().div(10).add(1.2).pow(player.p.baseAscend)
